...
$to = 'ovi_tsb@yahoo.com';			// Adresa de e-mail la care va fi trimis mesajul
...
if(isset($_SESSION['limit_contact']) && $_SESSION['limit_contact']>(time()-100)) {
  echo 'Se poate trimite cel mult un mesal la 2 minute.<br />Mai asteptati '.($_SESSION['limit_contact']-time()+300).' secunde';
  exit;
}
